...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('engagement.database.tables.bookmark_collections', 'bookmark_collections'), function (Blueprint $table) use ($jsonType): void {
